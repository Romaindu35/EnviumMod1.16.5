...
public class Meerkat extends AnimalEntity {
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.defineId(PigEntity.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> BOOST_TIME = EntityDataManager.defineId(PigEntity.class, DataSerializers.INT);
    private static final Ingredient TEMPTATION_ITEMS = Ingredient.of(Items.CARROT, Items.POTATO, Items.BEETROOT);
    private boolean boosting;
    private int boostTime;
    private int totalBoostTime;

    public Meerkat(EntityType<? extends Meerkat> p_i50250_1_, World p_i50250_2_) {
    ...
    public static AttributeModifierMap.MutableAttribute createAttributes() {
        return MobEntity.createMobAttributes().add(Attributes.MAX_HEALTH, 10.0D).add(Attributes.MOVEMENT_SPEED, (double)0.25D);
    }
    ...
    public ActionResultType interactAt(PlayerEntity player, Vector3d vec, Hand hand) {
        if (super.interactAt(player, vec, hand) == ActionResultType.SUCCESS) {
            ...
            if (itemstack.getItem() == Items.NAME_TAG) {
                ...
                return itemstack.getItem() == Items.SADDLE && itemstack.interactLivingEntity(player, this, hand) == ActionResultType.SUCCESS ? ActionResultType.SUCCESS : ActionResultType.FAIL;
            }
        }
    }
