...
@OnlyIn(Dist.CLIENT)
public class CreativeScreenCustom extends DisplayEffectsScreen<net.minecraft.client.gui.screen.inventory.CreativeScreen.CreativeContainer> {
    /** The location of the creative inventory tabs texture */
    private static final ResourceLocation RECIPE_BUTTON_TEXTURE = new ResourceLocation(References.MODID,"textures/gui/metier_button.png");
    ...
    public CreativeScreenCustom(PlayerEntity player) {
        super(new net.minecraft.client.gui.screen.inventory.CreativeScreen.CreativeContainer(player), player.inventory, new StringTextComponent(""));
    ...
    public void tick() {
        if (!this.minecraft.playerController.isInCreativeMode()) {
            this.minecraft.displayGuiScreen(new InventoryScreenCustom(this.minecraft.player));
        ...
        if (slotIn == null && selectedTabIndex != ItemGroup.INVENTORY.getIndex() && type != ClickType.QUICK_CRAFT) {
            ...
            if (slotIn == this.destroyItemSlot && flag) {
                ...
                if (slotIn == this.destroyItemSlot) {
                    ...
                    this.minecraft.playerController.sendSlotPacket(itemstack1, ((CreativeScreenCustom.CreativeSlot)slotIn).slot.slotNumber);
                    ...
                    this.minecraft.player.container.slotClick(slotIn == null ? slotId : ((CreativeScreenCustom.CreativeSlot)slotIn).slot.slotNumber, mouseButton, type, this.minecraft.player);
    ...
    protected void init() {
        if (this.minecraft.playerController.isInCreativeMode()) {
            ...
            this.addButton(new ImageButton(this.guiLeft + 204, this.height / 2 -100, 20, 18, 0, 0, 19, RECIPE_BUTTON_TEXTURE, (p_214086_1_) -> {
                ((ImageButton)p_214086_1_).setPosition(this.guiLeft + 104, this.height / 2 - 22);
                this.minecraft.displayGuiScreen(new MetierScreen.PrincipalScreen());
            }));
        } else {
            this.minecraft.displayGuiScreen(new InventoryScreenCustom(this.minecraft.player));
        }
    ...
    private void setCurrentCreativeTab(ItemGroup tab) {
        ...
        if (tab == ItemGroup.INVENTORY) {
            ...
            for(int l = 0; l < container.inventorySlots.size(); ++l) {
                ...
                Slot slot = new CreativeScreenCustom.CreativeSlot(container.inventorySlots.get(l), l, i1, j1);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (itemgroup == ItemGroup.INVENTORY) {
            InventoryScreenCustom.drawEntityOnScreen(this.guiLeft + 88, this.guiTop + 45, 20, (float)(this.guiLeft + 88 - mouseX), (float)(this.guiTop + 45 - 30 - mouseY), this.minecraft.player);
        }
    ...
    public static class CreativeContainer extends Container {
        ...
        public CreativeContainer(PlayerEntity player) {
            ...
            for(int i = 0; i < 5; ++i) {
                for(int j = 0; j < 9; ++j) {
                    this.addSlot(new CreativeScreenCustom.LockedSlot(CreativeScreenCustom.TMP_INVENTORY, i * 9 + j, 9 + j * 18, 18 + i * 18));
                }
            }
            ...
            for(int k = 0; k < 5; ++k) {
                for(int l = 0; l < 9; ++l) {
                    ...
                    if (i1 >= 0 && i1 < this.itemList.size()) {
                        CreativeScreenCustom.TMP_INVENTORY.setInventorySlotContents(l + k * 9, this.itemList.get(i1));
                    } else {
                        CreativeScreenCustom.TMP_INVENTORY.setInventorySlotContents(l + k * 9, ItemStack.EMPTY);
                    }
                }
            }
        ...
        public boolean canMergeSlot(ItemStack stack, Slot slotIn) {
            return slotIn.inventory != CreativeScreenCustom.TMP_INVENTORY;
        }
